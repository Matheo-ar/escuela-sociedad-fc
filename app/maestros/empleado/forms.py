...
class Employee(FlaskForm):
    ...
    FieldEmployee = StringField('Sede Empleado: ', validators=[
                            DataRequired(
                            message='La sede es obligatoria'
                            )])
    ActiveEmployee = StringField('Estado: ', validators=[
                            DataRequired(
                            message='El estado es obligatorio'
                            )])
    TypeEmployee= StringField('Tipo Empleado: ', validators=[
                            DataRequired(
                            message='El Tipo de empleado es obligatorio'
                            )])
